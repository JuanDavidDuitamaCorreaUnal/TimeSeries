...
pacf(residuales,lag.max = 50)
#Test de autocorrelaci?n
Box.test(residuales, lag = (length(residualesSARIMA)/4), type = "Ljung-Box", fitdf = 16)
######Análisis de Outliers
#Test de normalidad
jarque.bera.test(residualesSARIMA)
...
Este modelo logró pasar todos los supuestos, por lo que trabajaremos con este evaluando su ECM haciendo rolling.
